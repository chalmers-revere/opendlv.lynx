...
# completeBuild.sh - Script to build opendlv.mantis
...
echo "[Docker builder] Complete build of opendlv.mantis."
cmake -E remove_directory .
CCACHE_DIR=/opt/ccache PATH=/usr/lib/ccache:/opt/od4/bin:$PATH cmake -D CXXTEST_INCLUDE_DIR=/opt/opendlv.mantis.sources/thirdparty/cxxtest -D OPENDAVINCI_DIR=/opt/od4 -D PACKAGING_ENABLED=$PACKAGING_ENABLED -D ODVDOPENDLVSTANDARDMESSAGESET_DIR=/opt/opendlv.core -D CMAKE_INSTALL_PREFIX=/opt/opendlv.mantis /opt/opendlv.mantis.sources
